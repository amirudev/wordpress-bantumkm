                ...
                <div class="product-headesc">
                    ...
                    <div class="contact row d-flex justify-content-between">
                        <div class="whatsapp col-6">
                            <button class="btn btn-outline-success w-100" id="whatsappbutton"> <!--THIS POINT -->
                            <!--  href="<?php echo get_template_directory_uri(); ?>/functions/products-whatsapp.php?name=<?php echo get_the_title(); ?>&price=<?php echo get_field('price'); ?>" -->
...
<?php get_footer();
require('components/products-orderform.php');
?>