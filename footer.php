		...
		<div class="footer-top d-flex justify-content-around py-4">
			...
			<div class="contact m-3">
				...
				<div class="contact-item">
					<a href="https://wa.me/<?php echo get_theme_mod('wp_contactinfo-contact') ?>" class="plain-link">
					...
					</svg> <?php echo get_theme_mod('wp_contactinfo-contact') ?>
					</a>
				</div>
			</div>
			<div class="address m-3">
				<span class="footer-text-header fs-6 fw-bold">Informasi Alamat</span>
				<p class="text-secondary"><img src="<?php echo get_template_directory_uri(); ?>/assets/logo/map.svg"></img> <?php echo get_theme_mod('wp_contactinfo-address') ?></p>
			</div>
		</div>
		<div class="copyright">
